...
Records audio in chunks, transcribes with whisper.cpp, extracts topics from frequent words, and optionally summarizes with Ollama. All processing runs locally.
